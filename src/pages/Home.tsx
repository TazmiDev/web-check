  ...
  return (
    <HomeContainer>
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          <a href="https://github.com/TazmiDev/web-check" title="Check out the source code and documentation on GitHub, and get support or contribute">
            <Button>View on GitHub</Button>
          </a>
          <a href="https://github.com/TazmiDev" title="My Github page">
