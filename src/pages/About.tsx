...
const About = (): JSX.Element => {
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a href="https://github.com/TazmiDev/web-check"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <p>
          ...
          It's licensed under the <a href="https://github.com/TazmiDev/web-check/blob/master/LICENSE">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a href="https://github.com/TazmiDev/web-check">GitHub</a>.
      ...
      <Section>
        ...
        <a href="https://app.netlify.com/start/deploy?repository=https://github.com/TazmiDev/web-check">
        ...
        <pre>
        git clone https://github.com/TazmiDev/web-check.git<br />
        ...
        <p>
          ...
          GitHub repository - <a href="https://github.com/TazmiDev/web-check#readme">github.com/lissy93/web-check</a>
        </p>
...
- `REACT_APP_API_ENDPOINT` (e.g. `/api`) - The endpoint for the API (can be local or remote)</p> */}
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a href="https://github.com/TazmiDev/web-check">Web-Check</a> is distributed under the MIT license,
